...
!call gp%plot(linspace(1.0_wp,6.0_wp,6),error_array_linear(1:6))
...
!call gp%plot(linspace(1.0_wp,6.0_wp,6), error_array_cubic(1:6))
...
! ---------
!allocate(y(n(2)+2))
!y = linspace(0.0_wp, 1.0_wp, n(2)+2)
!write(*,*) y
...
! Test Two
! ---------
!y_eval = linspace(y(1),y(4),51)
!i = 1
!call set_inner_product(ipo,y,i,n(1),&
!                      k,cubic_spline_basis,.true.)
!do j = 1, 51
!  basis_plot(j) = ipo%eval(y_eval(j))
!end do
